...
public class HomeController {
	...
	public String getCommang(Model model, @RequestParam("name") String name, String addr, HttpServletRequest request) {
		// 넘어온 이름이 변수이름과 같으면 @RequesteParam("") 생략 가능
	...
	public String postCommand(Model model, @ModelAttribute AddressDto dto){
		// @ModelAttribute AddressDto 변수 이름이 같으면 자동으로 mapping된다.
