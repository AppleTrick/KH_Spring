...
public interface MyBoardMapper {
	...
	@Select("SELECT MYNO, MYNAME, MYTITLE, MYCONTENT, MYDATE FROM MYBOARD WHERE MYBO = #{myno}")
	...
	@Update("UPDATE MYBOARD SET MYTITLE = #{myname}, MYCONTENT = #{mycontent}, WHERE MYNO = #{myno} ")
