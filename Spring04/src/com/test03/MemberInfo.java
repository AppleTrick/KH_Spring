...
/*
 * 
 * MessageSourceAware 는 번들이 지정된 properties 파일을 setMessageSource()로 전달한다. -> 메세지 국제화를 위해 사용
 * 
 * ResourceBundleMessageSource 의 setBaseName()을 통해 전달 받은 파일을,
 * setMessageSource()를 자동으로 호출하여 매핑하는 역할을 한다./
 * 
 * ResourceBundleMessageSource 와 MessageSourceAware 는 쌍으로 사용한다.
 */
